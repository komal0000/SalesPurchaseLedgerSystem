            ...
            <div class="rounded-xl border border-gray-300 bg-white p-4 shadow-sm">
                <div class="grid gap-4 md:grid-cols-12 md:items-end">
                    <div class="md:col-span-8">
                        ...
                        <select id="sale-party-select" name="party_id" x-model="partyId" x-ref="party" @keydown.enter.prevent="focus('itemParticular')" class="select2 mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200" required>
