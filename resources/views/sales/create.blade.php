...
@section('content')
    <div class="space-y-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Create Sale</h1>
            <p class="text-sm text-gray-500">Enter items manually. Totals are calculated automatically.</p>
        </div>

        <form action="{{ route('sales.store') }}" method="POST" class="space-y-6" x-data="billForm()">
            @csrf
