                            ...
                            <tr class="border-t border-gray-100 hover:bg-gray-50/80">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-end gap-4">
                                        ...
                                        <a href="{{ route('payments.create', ['party_id' => $purchase->party_id]) }}" class="text-sm text-green-600 hover:text-green-700">Payment</a>
            ...
            @forelse ($purchases as $purchase)
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    <div class="mt-4 flex items-center justify-between border-t border-gray-100 pt-3 text-sm">
                        ...
                        <a href="{{ route('payments.create', ['party_id' => $purchase->party_id]) }}" class="font-medium text-green-600">Add Payment</a>
                    </div>
                </div>
            @empty
